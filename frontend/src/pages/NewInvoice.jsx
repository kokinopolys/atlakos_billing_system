...
// Simple client-side number to words for preview
const ONES_ES = [
...
export default function NewInvoice() {
  ...
  const previewInvoice = {
    invoice_number: config
      ? `${config.invoice_prefix}-${String(parseInt(config.invoice_sequence || 1)).padStart(8, '0')}`
      : '000-001-01-00000001',
    doc_type: 'factura',
    date,
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="w-1/2 overflow-y-auto p-5 border-r border-gray-200 bg-white">
        <h1 className="text-xl font-bold text-gray-900 mb-4">Nueva Factura</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <table className="w-full text-xs border-collapse">
                <thead>
                  <tr className="bg-blue-700 text-white">
                    <th className="px-2 py-2 text-left font-semibold border border-blue-600" style={{ width: '70px' }}>Cantidad</th>
                    <th className="px-2 py-2 text-left font-semibold border border-blue-600">Descripción</th>
                    <th className="px-2 py-2 text-right font-semibold border border-blue-600" style={{ width: '110px' }}>Precio Unit.</th>
                    <th className="px-2 py-2 text-right font-semibold border border-blue-600" style={{ width: '100px' }}>Valor Total</th>
                    <th className="px-2 py-2 border border-blue-600" style={{ width: '32px' }}></th>
                  </tr>
                </thead>
                <tbody>
                  {items.map((item, idx) => {
                      ...
                      <tr key={idx} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                        <td className="border border-gray-200 p-0">
                          <input
                            ...
                            className="w-full px-2 py-2 text-right bg-transparent border-0 focus:outline-none focus:bg-blue-50 text-xs"
                          />
                        </td>
                        <td className="border border-gray-200 p-0">
                          <input
                            ...
                            className="w-full px-2 py-2 bg-transparent border-0 focus:outline-none focus:bg-blue-50 text-xs"
                          />
                        </td>
                        <td className="border border-gray-200 p-0">
                          <input
          ...
          {taxIncluded !== null && (
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
              ...
              <div className="space-y-1 text-sm">
                ...
                <div className="flex justify-between font-bold text-gray-900 text-base border-t border-blue-300 pt-2 mt-2">
                  <span>TOTAL</span>
                  <span className="text-blue-700">L. {fmt(totals.total)}</span>
                </div>
              </div>
            </div>
          )}
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-3 bg-green-600 hover:bg-green-700 disabled:bg-green-400 text-white font-bold text-sm rounded-xl transition-colors"
          >
